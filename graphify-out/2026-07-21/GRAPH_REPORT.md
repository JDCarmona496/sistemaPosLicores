...
## Corpus Check
- 153 files · ~78,119 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1926 nodes · 2661 edges · 162 communities (148 shown, 14 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 13 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `83051a12`
...
- `_buildDeliveryTypeDropdown` --references--> `ordersProvider`  [EXTRACTED]
  lib/ui/features/orders/views/widgets/order_filter_bar.dart → lib/data/providers/order_list_providers.dart
- `_buildSearch` --references--> `ordersProvider`  [EXTRACTED]
  lib/ui/features/orders/views/widgets/order_filter_bar.dart → lib/data/providers/order_list_providers.dart
...
Cohesion: 0.11
Nodes (18): _addressController, _buildHeader, _buildMobileBody, _buildTypeSection, createState, _currentUserId, _deliveryFeeController, dispose (+10 more)

### Community 3 - "order_repository.dart"
Cohesion: 0.07
Nodes (31): ../../../../../domain/models/order.dart, ReceiptGenerator, EscPosReceiptGenerator, _formatMoney, generateOrderReceipt, generateTestPage, _truncate, _buildItemRow (+23 more)
...
Cohesion: 0.06
Nodes (32): FormState, customerRepositoryProvider, _addressController, build, _buildSection, createState, _creditLimitController, _currentBalanceController (+24 more)
...
Cohesion: 0.08
Nodes (23): Color, ../../../../data/providers/printer_provider.dart, ../../../../data/services/printer/printer_service.dart, _availableConnectionTypes, _buildConnectionStatusCard, _buildDeviceScanner, _buildDisconnectButton, _buildInfoCard (+15 more)
...
Cohesion: 0.14
Nodes (15): ../../../../../domain/models/order_item.dart, OrderItemSupabaseExtension, dbValue, fromJson, isColdPrice, isFullyDelivered, isWholesalePrice, OrderItem (+7 more)
...
Cohesion: 0.11
Nodes (20): ConsumerWidget, ../../../../domain/models/product.dart, productByIdProvider, deliveryUsersProvider, build, DeliveryPersonSelectorDialog, _buildCartItem, OrderCartPanel (+12 more)

### Community 31 - "package:flutter/material.dart"
Cohesion: 0.29
Nodes (7): ResponsiveBuilder, ResponsiveVisibility, LicoreriaApp, DeliveryZoneGroupCard, _FilterDropdown, OrderZoneGroupCard, StatelessWidget
...
Cohesion: 0.25
Nodes (11): orderByIdProvider, orderItemsProvider, printOrderReceiptProvider, build, DeliveryOrderDetailView, _DeliveryOrderDetailViewState, _markAllDelivered, build (+3 more)
...
Cohesion: 0.10
Nodes (22): geocode_address_button.dart, currentOrderCartProvider, build, _buildCustomerSection, initState, _selectCustomer, addressController, build (+14 more)

### Community 54 - "product.dart"
Cohesion: 0.29
Nodes (6): ../../../../../data/providers/order_providers.dart, build, canSave, isLoading, onSave, OrderCreateBottomBar

### Community 55 - "State"
Cohesion: 0.32
Nodes (8): LoginView, _LoginViewState, DashboardView, _DashboardViewState, QuantitySelector, _QuantitySelectorState, State, StatefulWidget
...
Cohesion: 0.11
Nodes (20): dart:io, ../../../../../data/services/delivery_evidence_service.dart, orderRepositoryProvider, build, _confirm, createState, DeliverySignatureDialog, _DeliverySignatureDialogState (+12 more)
...
Cohesion: 0.11
Nodes (18): FocusNode, int?, build, _commit, _controller, createState, _decrement, didUpdateWidget (+10 more)
...
Cohesion: 0.20
Nodes (10): OrderSupabaseExtension, Order, build, _buildInfoChip, _buildStatusChip, _getDeliveryTypeIcon, _getSaleTypeIcon, getStatusColor (+2 more)
...
Cohesion: 0.26
Nodes (12): ConsumerState, ConsumerStatefulWidget, geocodingContextProvider, geocodingServiceProvider, _geocode, GeocodeCustomerAddressButton, _GeocodeCustomerAddressButtonState, _geocode (+4 more)

### Community 96 - "package:go_router/go_router.dart"
Cohesion: 0.22
Nodes (8): ../../../../data/providers/settings_providers.dart, build, _editGeocodingContext, SettingsView, package:go_router/go_router.dart, Route /settings/brands, Route /settings/categories, Route /settings/printer
...
Cohesion: 0.12
Nodes (16): _buildBottomBar, _buildCustomerInfo, _buildItemCard, _buildNotes, _buildOrderHeader, _buildProductsHeader, _buildStatusChip, _canDeliver (+8 more)
...
Cohesion: 0.12
Nodes (15): ../../../../../data/providers/user_providers.dart, ../../../../../domain/services/route_optimizer.dart, build, _buildActionChip, _buildActions, _buildBody, _buildHeader, _buildStatusChip (+7 more)
...
Cohesion: 0.16
Nodes (14): ordersProvider, currentUserProvider, DeliveryOrderCard, _showDeliveryFailureDialog, _saveOrder, _assignDeliveryPerson, _cancelOrder, build (+6 more)
...
Cohesion: 0.17
Nodes (11): ../../../../../core/responsive.dart, _buildDeliveryTypeDropdown, _buildSearch, highlighted, icon, items, label, onChanged (+3 more)
...
Cohesion: 0.31
Nodes (8): @freezed, customer.dart, CustomerBasket, CustomerBasketSupabaseExtension, Customer, CustomerSupabaseExtension, toSupabaseJson, User
...
### Community 136 - "geocode_address_button.dart"
Cohesion: 0.29
Nodes (6): addressController, build, createState, _isLoading, _showSnack, TextEditingController
...
Cohesion: 0.50
Nodes (3): build, ReportsView, package:flutter/material.dart

## Knowledge Gaps
- **1080 isolated node(s):** `$schema`, `.opencode/plugins/graphify.js`, `XCTest`, `AppConfig`, `appName` (+1075 more)
...
- **Why does `CurrentOrderCartNotifier` connect `supabase_health_check_view.dart` to `StateNotifier`, `payment.dart`?**
